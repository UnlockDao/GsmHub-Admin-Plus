                            ...
                            <table id="fixTable" class="table align-items-center table-flush">
                                ...
                                @foreach($group->where('imeigroup','<>','') as $g)
                                    <tr class="table-warning">
                                        ...
                                        <td colspan="5"><strong style="font-weight:700;">{{$g->group_name}}</strong>
                                        </td>
                                        @foreach($usergroup as $u)
                                            <td></td>
                                        @endforeach
                                        ...
                                        @if($v->imei_service_group_id == $g->id )
                                            <tr>
                                                ...
                                                <td @if($v->status == 'soft_deleted' )style="text-decoration: line-through;"@endif>
                                                    <a class="@if($v->imeipricing->sale >0) badge1 @endif"
                                                       @if($v->imeipricing->sale >0) data-badge="{{$v->imeipricing->sale}}" @endif > {{$v->service_name}}</a>
                                                </td>
